...
INSTRUCTIONS_TO_SHOOT_VIDEO_TEXT_MANAGER = (
    "📹 Запишите приветственное видео для соискателя (не более 60 сек).\n" 
    " • Несколько слов о компании, вакансии\n"
    " • Особые требования (если есть)\n"
    " • Смотрите в камеру и улыбайтесь\n"
    " • Не переживайте о качестве видео, искателю важнее увидеть живого человека, а не идеально отреперированную речь.\n"
    "--------------------------\n"
...
INFO_ABOUT_ANALYZING_VACANCY_TEXT = "🧐 Читаю вакансиию, анализирую критерии отбора кандидатов.\nНашипу в чат когда будет готово."
INFO_ABOUT_SOURCING_CRITERIAS_TEXT = "🔍 Критерии отбора кандидатов."

# ----- WELCOME TEXT (APPLICANT BOT) -----
WELCOME_TEXT_WHEN_STARTING_BOT_APPLICANT = "👋 Здравствуйте. Я ИИ-ассистент, покажу вам приветсвенное видео менеджера."

# ----- WELCOME TEXT (MANAGER BOT) -----
WELCOME_TEXT_WHEN_STARTING_BOT = "👋 Здравствуйте. Я ИИ-ассистент для работы с откликами на HeadHunter."

# ----- AUTH TEXT (MANAGER BOT) -----
AUTH_REQ_TEXT = "🔌 Авторизуйтесь на сайте HeadHunter чтобы у меня был доступ к вашим открытым вакансиям. "
AUTH_SUCCESS_TEXT = "✅ Авторизация завершена."
...
SUCCESS_TO_SAVE_VIDEO_TEXT = "✅ Видео успешно сохранено."
SUCCESS_TO_GET_SOURCING_CRITERIAS_TEXT = "Я уже проанализировал вакансию и определил критерии для отбора кандидатов."
SUCCESS_TO_GET_SOURCING_CRITERIAS_CONFIRMATION_TEXT = "✅ Критерии отбора согласованы."
SUCCESS_TO_START_SOURCING_TEXT = "🏃‍♂️ Пошел искать лучших кандидатов в откликах на вакансию."
