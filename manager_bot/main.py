...
async def run_manager_bot() -> None:
    ...
    application.add_handler(CommandHandler("admin_get_criterias_visualization", admin_get_sourcing_criterais_visualization_command))
    ...
    application.add_handler(CommandHandler("admin_source_and_analyze_resume", admin_source_and_analyze_resume_command))
    application.add_handler(CommandHandler("admin_get_recommendation_visualization", admin_get_recommendation_visualization_command))
    application.add_handler(CommandHandler("admin_send_recommendation_to_user", admin_send_recommendation_to_user_command))
